            ...
            <section className="space-y-4 ">
              <div className="space-y-2">
               <h2 className="flex gap-1 text-2xl  items-end ">
                ...
                <Container className=" gap-10 px-6 items-center bg-[#AE6BF3]">
              ...
              <div className=" flex gap-4">
                {/* left  */}
                <Container className="w-fit bg-[#AE6BF3] justify-center flex-col px-4 items-center ">
